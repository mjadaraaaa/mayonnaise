...
class CityPictureController extends Controller
{
    ...
    public function addCityMedia(Request $request){
        ...
        $city_media =CityPicture::create(['media'=>$file_name,
        'city_id'=>$city_id,                                                                                                                            
        ]);
            return response()->json([
                'status'=>'success',
                'message'=>'city media added successfully',
    ...
    public function deleteCityMedia($media_id){
        try{
            $user = Auth::user();
            $media = CityPicture::findorfail($media_id);
            $media->delete();
              return response()->json([
                'status' => 'success',
