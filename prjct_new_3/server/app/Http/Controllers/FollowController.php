...
class FollowController extends Controller
{
    ...
    public function getFollowings(Request $request)
    {
        try {
            ...
            return response()->json([
                'status' => 'error',
                'message' => 'An error occurred while trying to retrieve followers',
            ]);
        }
    }
    ...
    public function getFollowers(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                'status' => 'error',
                'message' => 'An error occurred when trying to retrieve followers',
            ]);
        }
    }
    ...
    public function isFollowing(Request $request,$user_id)
    {
        try{
            ...
            return response()->json([
                ...
                'status' => 'failed',
                'message' => 'you dont follow user: '.$user_id,
            ]);
            ...
            return response()->json([
                ...
                'status' => 'error',
                'message' => "error when trying to get result",
            ]);
