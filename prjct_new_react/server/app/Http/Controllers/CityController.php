...
class CityController extends Controller
{
    ...
    public function deleteCity($city_id)
    {
        try {
            ...
            return response()->json([
                'status' => 'error',
                'message' => 'an error occured while trying to delete city'.$ex,
            ]);
        }
    }
    ...
    public function getCity($city_id)
    {
        try {
            ...
            $city = City::with('cityPictures')->findorfail($city_id);
            ...
            return response()->json([
                'status' => 'exception',
                'message' => 'an error occured while trying to get city',
            ]);
        }
    }
    ...
    public function getAllCities()
    {
        try {
            ...
            return response()->json([
                'status' => 'error',
                'message' => 'an error occured while trying to retrieve cities ',
