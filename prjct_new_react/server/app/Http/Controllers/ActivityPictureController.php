...
class ActivityPictureController extends Controller
{
    public function addActivityMedia(Request $request)
    {
        try {
            ...
            $validator = Validator::make(
                $request->all(),
                [
                    'media' => 'required|mimes:jpeg,jpg,png,avi,m4,mp4,mpeg|max:2048',
                ],
                $messages,
            );
         ...
         //dd($request->all());
            ...
            return response()->json([
                'status' => 'success',
                'message'=>'activity media added successfully',
            ...
            return response()->json([
                'status' => 'error',
                  'message'=>'an error occured while adding activity media'.$ex,
     ...
     public function addActivityMultiMedia(Request $request)
    {
        try {
            ...
            return response()->json([
                'status' => 'error',
                'message'=>'an error occured while adding activity media',
            ]);
        }
    }
    ...
    public function deleteActivityMedia($media_id){
        ...
        try{
            ...
            return response()->json([
                'status' => 'error',
               'message' => 'an error occured while trying to delete media',
