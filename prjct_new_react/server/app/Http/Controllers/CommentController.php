...
class CommentController extends Controller
{
    ...
    public function getCommentReplies($replying_to_id)
    {
        try {
            ...
            return response()->json([
                "status" => "error",
                "message" => "an error occured while trying to retrieve replies",
            ]);
        }
    }
    ...
    public function getComment($comment_id)
    {
        try {
            ...
            return response()->json([
                "status" => "error",
                "message" => "an error occured while to retrieve comment",
            ]);
        }
    }
    ...
    {
        try {
            $comments = Comment::with("user")->where("activity_id", $activity_id)->where('is_reply',0)->get();
            return response()->json([
                "status" => "success",
