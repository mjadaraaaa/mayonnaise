...
async function getCity(city_id){
    ...
    try{
        const res = await axios.get(`${baseUrl}getCity/${city_id}`,auth());
        const data = res.data ;
        return {data};
...
async function getAllActivities(){
    ...
    try{
        const res =await axios.get(`${baseUrl}getAllActivities`,auth());
        const data = res.data 
...
async function adminActivitySearch(query) {
    ...
    try{
        const res = await axios.post(`${baseUrl}user/admin/adminActivitySearch`,{search : query},auth());
        const data =res.data ;
        return {data};
    }catch(error){
        throw error ;
...
async function adminCitySearch(query) {
    ...
    try{
        const res = await axios.post(`${baseUrl}user/admin/adminCitySearch`,{search : query},auth());
        const data =res.data ;
        return {data};
    }catch(error){
        throw error ;
...
export { getAllCities, getCity,getCityActivities ,addCityMedia ,addCity ,editCity 
    ,deletecity ,addActivityType , editActivityType , searchActivities ,getAllActivities , getActivity, getActivityComments , deleteActivity ,adminActivitySearch ,adminCitySearch };
